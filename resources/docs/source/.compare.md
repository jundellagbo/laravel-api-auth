...
--------- | ------- | ------- | ------- | -----------
    `firstName` | string |  required  | max:100
        ...
        `password` | string |  required  | max:20,min:5,unique,confirmed:password_confirmation
        `gender` | string |  optional  | max:6
        `birthDate` | string |  optional  | MM-DD-YYYY
        `watsappNumber` | string |  optional  | max:15
        `phoneNumber` | string |  optional  | max:15
        `passportNumber` | string |  optional  | max:25
        `visaNumber` | string |  optional  | max:25
        `accessCardNumber` | string |  optional  | max:25
...
<!-- START_d04d24f054d5e9436595ea3b48d9e2ec -->
...
```bash
curl -X POST \
    "http://localhost/api/v1/auth/request-reset-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
<!-- START_86440747441f391a588ff9c6441c5de4 -->
...
```bash
curl -X GET \
    -G "http://localhost/api/v1/user/me" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
<!-- END_86440747441f391a588ff9c6441c5de4 -->

<!-- START_f10bec866a6f1eae832af7ed79b5545a -->
...
```bash
curl -X GET \
    -G "http://localhost/api/v1/user/verify/resend" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/api/v1/user/verify/resend"
);
